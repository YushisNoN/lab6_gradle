...
public class ExecuteScript extends Command {
    ...
    public void execute(String[] arguments)
        ...
        try {
            ...
            FileInputStream scriptInput = new FileInputStream(arguments[arguments.length - 1]);

            InputStream originalInput = System.in;
            System.setIn(scriptInput);

            this.kernel.consoleManager = new ConsoleHandler();
            this.kernel.consoleManager.setInputSource(new FileInputStream(arguments[arguments.length - 1]));
            this.kernel.runProgram();
            System.setIn(originalInput);
            this.kernel.consoleManager.setInputSource(System.in);
